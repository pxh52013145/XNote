...
fn en_us_dict() -> HashMap<&'static str, &'static str> {
    HashMap::from([
        ...
        ("settings.ai.connection.state.partial", "partial"),
        ...
        (
            "settings.ai.connection.hint.partial",
            "Chat endpoint is available, but admin endpoints are partially unavailable.",
        ),
        (
        ...
        ("settings.ai.card.runtime.title", "Runtime & Sync"),
        (
            "settings.ai.card.runtime.desc",
            "Advanced VCP runtime options: admin endpoint, auth header, timeout, and ws sync.",
        ),
        ("settings.ai.runtime.admin_endpoint", "Admin endpoint"),
        ("settings.ai.runtime.ws_endpoint", "WebSocket endpoint"),
        ("settings.ai.runtime.timeout", "Request timeout"),
        ("settings.ai.runtime.sync_ws", "WS sync"),
        ("settings.ai.runtime.sync_ws.on", "enabled"),
        ("settings.ai.runtime.sync_ws.off", "disabled"),
        (
            "settings.ai.runtime.edit_admin_endpoint",
            "Edit admin endpoint",
        ),
        ("settings.ai.runtime.edit_admin_auth", "Edit admin auth"),
        ("settings.ai.runtime.edit_timeout", "Edit timeout"),
        ("settings.ai.runtime.toggle_sync_ws", "Toggle WS sync"),
        (
            "settings.ai.status.admin_endpoint_set",
            "AI admin endpoint set to",
        ),
        (
            "settings.ai.status.admin_auth_set",
            "AI admin auth header updated",
        ),
        ("settings.ai.status.timeout_set", "AI timeout set to"),
        (
            "settings.ai.status.sync_ws_enabled",
            "VCP WebSocket sync enabled",
        ),
        (
            "settings.ai.status.sync_ws_disabled",
            "VCP WebSocket sync disabled",
        ),
        (
            "settings.ai.edit.target.admin_endpoint",
            "Editing admin endpoint",
        ),
        ("settings.ai.edit.target.admin_auth", "Editing admin auth"),
        ("settings.ai.edit.target.timeout", "Editing request timeout"),
        (
        ...
        ("ai.hub.pane.chat", "Chat"),
        ("ai.hub.pane.agents", "Agents"),
        ("ai.hub.pane.tools", "Tools"),
        ("ai.hub.pane.memory", "Memory"),
        ("ai.hub.pane.tasks", "Tasks"),
        ("ai.hub.pane.nodes", "Nodes"),
        ("ai.hub.action.open_settings", "Open AI Settings"),
        ("ai.hub.meta.connection", "Connection"),
        ("ai.hub.meta.connection.checking", "checking"),
        ("ai.hub.meta.connection.connected", "connected"),
        ("ai.hub.meta.connection.partial", "partial"),
        ("ai.hub.meta.connection.offline", "offline"),
        ("ai.hub.meta.last_sync", "Last sync"),
        ("ai.hub.meta.last_sync.never", "never"),
        ("ai.hub.meta.auto_refresh.on", "Auto refresh on"),
        ("ai.hub.meta.auto_refresh.off", "Auto refresh off"),
        ("ai.hub.meta.refreshing", "Refreshing..."),
        ("ai.hub.meta.refresh", "Refresh now"),
        ("ai.hub.meta.ws_endpoint", "WS endpoint"),
        ("ai.hub.meta.timeout", "Timeout"),
        ("ai.hub.meta.tool_injection.on", "Tool injection is enabled"),
        ("ai.hub.meta.tool_injection.off", "Tool injection is disabled"),
        ("ai.hub.section.list.empty", "No data"),
        ("ai.hub.section.agents", "Agents"),
        ("ai.hub.section.clusters", "Clusters"),
        ("ai.hub.section.plugins", "Plugins"),
        ("ai.hub.section.rag_tags", "RAG tags"),
        ("ai.hub.section.config", "Runtime config"),
        ("ai.hub.section.schedules", "Schedules"),
        ("ai.hub.section.metrics", "Metrics"),
        ("ai.hub.section.warnings", "Warnings"),
...
fn zh_cn_dict() -> HashMap<&'static str, &'static str> {
    HashMap::from([
        ...
        ("settings.ai.connection.state.partial", "部分连接"),
        ...
        ("settings.ai.card.runtime.title", "运行时与同步"),
        (
            "settings.ai.card.runtime.desc",
            "高级 VCP 运行参数：管理端点、鉴权头、超时和 ws 同步。",
        ),
        ("settings.ai.runtime.admin_endpoint", "管理端点"),
        ("settings.ai.runtime.ws_endpoint", "WebSocket 端点"),
        ("settings.ai.runtime.timeout", "请求超时"),
        ("settings.ai.runtime.sync_ws", "WS 同步"),
        ("settings.ai.runtime.sync_ws.on", "已启用"),
        ("settings.ai.runtime.sync_ws.off", "已关闭"),
        ("settings.ai.runtime.edit_admin_endpoint", "编辑管理端点"),
        ("settings.ai.runtime.edit_admin_auth", "编辑管理鉴权"),
        ("settings.ai.runtime.edit_timeout", "编辑超时"),
        ("settings.ai.runtime.toggle_sync_ws", "切换 WS 同步"),
        ("settings.ai.status.admin_endpoint_set", "AI 管理端点已设置为"),
        ("settings.ai.status.admin_auth_set", "AI 管理鉴权头已更新"),
        ("settings.ai.status.timeout_set", "AI 超时已设置为"),
        ("settings.ai.status.sync_ws_enabled", "VCP WebSocket 同步已启用"),
        ("settings.ai.status.sync_ws_disabled", "VCP WebSocket 同步已关闭"),
        ("settings.ai.edit.target.admin_endpoint", "当前编辑：管理端点"),
        ("settings.ai.edit.target.admin_auth", "当前编辑：管理鉴权"),
        ("settings.ai.edit.target.timeout", "当前编辑：请求超时"),
        (
            "ai.hub.ui.input.disabled_placeholder",
            "VCP disconnected: run Apply & Check in Settings > AI",
        ),
        ...
        ("ai.hub.pane.chat", "对话"),
        ("ai.hub.pane.agents", "代理"),
        ("ai.hub.pane.tools", "工具"),
        ("ai.hub.pane.memory", "记忆"),
        ("ai.hub.pane.tasks", "任务"),
        ("ai.hub.pane.nodes", "节点"),
        ("ai.hub.action.open_settings", "打开 AI 设置"),
        ("ai.hub.meta.connection", "连接"),
        ("ai.hub.meta.connection.checking", "检查中"),
        ("ai.hub.meta.connection.connected", "已连接"),
        ("ai.hub.meta.connection.partial", "部分连接"),
        ("ai.hub.meta.connection.offline", "离线"),
        ("ai.hub.meta.last_sync", "上次同步"),
        ("ai.hub.meta.last_sync.never", "从未"),
        ("ai.hub.meta.auto_refresh.on", "自动刷新：开"),
        ("ai.hub.meta.auto_refresh.off", "自动刷新：关"),
        ("ai.hub.meta.refreshing", "刷新中..."),
        ("ai.hub.meta.refresh", "立即刷新"),
        ("ai.hub.meta.ws_endpoint", "WS 端点"),
        ("ai.hub.meta.timeout", "超时"),
        ("ai.hub.meta.tool_injection.on", "工具注入已启用"),
        ("ai.hub.meta.tool_injection.off", "工具注入已关闭"),
        ("ai.hub.section.list.empty", "暂无数据"),
        ("ai.hub.section.agents", "代理列表"),
        ("ai.hub.section.clusters", "集群"),
        ("ai.hub.section.plugins", "插件"),
        ("ai.hub.section.rag_tags", "RAG 标签"),
        ("ai.hub.section.config", "运行配置"),
        ("ai.hub.section.schedules", "计划任务"),
        ("ai.hub.section.metrics", "运行指标"),
        ("ai.hub.section.warnings", "告警"),

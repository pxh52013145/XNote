...
fn en_us_dict() -> HashMap<&'static str, &'static str> {
    HashMap::from([
        ...
        (
            ...
            "Apply current AI settings to runtime environment variables.",
        ),
        (
        ...
        ("ai.hub.ui.agent_panel.title", "VCP Agents"),
        ("ai.hub.ui.agent_panel.subtitle", "Active 4 · Group 1"),
        ("ai.hub.ui.agent.writer.name", "Writer"),
        ("ai.hub.ui.agent.writer.meta", "daily drafting · online"),
        ("ai.hub.ui.agent.researcher.name", "Researcher"),
        ("ai.hub.ui.agent.researcher.meta", "project tracking · idle"),
        ("ai.hub.ui.agent.planner.name", "Planner"),
        ("ai.hub.ui.agent.planner.meta", "idea synthesis · online"),
        ("ai.hub.ui.agent.coder.name", "Coder"),
        ("ai.hub.ui.agent.coder.meta", "tool execution · idle"),
        (
            "ai.hub.agent.instruction.writer",
            "Mode: Writer. Prioritize clear, polished writing that preserves user intent.",
        ),
        (
            "ai.hub.agent.instruction.researcher",
            "Mode: Researcher. Prioritize evidence, structure, and concise synthesis.",
        ),
        (
            "ai.hub.agent.instruction.planner",
            "Mode: Planner. Prioritize actionable plans, milestones, and checklists.",
        ),
        (
            "ai.hub.agent.instruction.coder",
            "Mode: Coder. Prioritize implementation details, correctness, and maintainability.",
        ),
        ("status.ready", "Ready"),
...
fn zh_cn_dict() -> HashMap<&'static str, &'static str> {
    HashMap::from([
        ...
        ("ai.hub.ui.agent_panel.title", "VCP 智能体"),
        ("ai.hub.ui.agent_panel.subtitle", "已激活 4 · 分组 1"),
        ("ai.hub.ui.agent.writer.name", "Writer"),
        ("ai.hub.ui.agent.writer.meta", "日常写作 · 在线"),
        ("ai.hub.ui.agent.researcher.name", "Researcher"),
        ("ai.hub.ui.agent.researcher.meta", "项目追踪 · 空闲"),
        ("ai.hub.ui.agent.planner.name", "Planner"),
        ("ai.hub.ui.agent.planner.meta", "创意整合 · 在线"),
        ("ai.hub.ui.agent.coder.name", "Coder"),
        ("ai.hub.ui.agent.coder.meta", "工具执行 · 空闲"),
        (
            "ai.hub.agent.instruction.writer",
            "模式：Writer。优先给出清晰、可读、保持原意的写作结果。",
        ),
        (
            "ai.hub.agent.instruction.researcher",
            "模式：Researcher。优先给出依据、结构化要点与简洁综合结论。",
        ),
        (
            "ai.hub.agent.instruction.planner",
            "模式：Planner。优先给出可执行计划、里程碑与检查清单。",
        ),
        (
            "ai.hub.agent.instruction.coder",
            "模式：Coder。优先给出实现细节、正确性与可维护性建议。",
        ),
        ("status.ready", "就绪"),
